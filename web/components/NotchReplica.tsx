...
export default function NotchReplica() {
  ...
  return (
    <div className="w-full overflow-hidden">
      <div className="mx-auto flex h-[176px] justify-center overflow-visible sm:h-[232px] lg:h-[300px]">
        <div className="origin-top scale-[0.58] sm:scale-[0.76] lg:scale-100">
          <div
                onMouseEnter={() => setOpen(true)}
              onMouseLeave={() => setOpen(false)}
              onClick={() => setOpen((v) => !v)}
              className="relative flex cursor-pointer justify-center pt-1"
              style={{ width: OPEN_W + 40, height: SHELL_H }}
          >
              <motion.div
                ...
                className="absolute top-0 h-fit overflow-hidden border border-white/10 bg-[#08080a]
                           shadow-[0_26px_70px_-14px_rgba(0,0,0,0.95)]"
              ...
              <div className="absolute left-1/2 top-1 z-20 h-[32px] w-[118px] -translate-x-1/2 rounded-b-[13px] bg-black" />
          </div>
